...
public final class NettyGatewayClient implements GatewayClient {
    ...
    public NettyGatewayClient(CoreManager coreManager, String host, int port, String clientType, @NotNull Map<String, String> parameters) {
        this.nettyClientThread = new NettyClientThread(coreManager, host, port, clientType, parameters, this::initReceiveCallbacks, this::initRegistrationCallbacks);
